...
class DiagramService:
    ...
    def create_diagram(self, diagram: Diagram, user: User):
        DiagramService.__prepare_to_persist(diagram, user)
    ...
    def find_diagram_by_id(self, diagram_id: UUID, user: User) -> Diagram:
    ...
    def find_diagrams_by_user(self, user: User) -> List[Diagram]:
        return self.diagram_repository.find_all_by_user(user)
